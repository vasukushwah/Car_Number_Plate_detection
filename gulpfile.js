...
var paths = {
    ...
    src: {
        ...
        css:  'static/argo/css',
        html: '**/*.html',
        img:  'static/argo/img/**/*.+(png|jpg|gif|svg)',
        js:   'static/argo/js/**/*.js',
        scss: 'static/argo/scss/**/*.scss'
    }
}
...
gulp.task('concat:js', function(done) {
	...
	files = [
		paths.src.base + '/static/argo/js/components/license.js',
		paths.src.base + '/static/argo/js/components/layout.js',
		paths.src.base + '/static/argo/js/components/init/*js',
		paths.src.base + '/static/argo/js/components/custom/*js',
		paths.src.base + '/static/argo/js/components/maps/*js',
		paths.src.base + '/static/argo/js/components/charts/*js',
		paths.src.base + '/static/argo/js/components/vendor/*js'
	];
...
gulp.task('minify:js', function(cb) {
    return gulp.src([
            paths.src.base + '/static/argo/js/argon.js'
        ])
        .pipe(uglify())
        .pipe(rename({ suffix: '.min' }))
        .pipe(gulp.dest(paths.dist.base + '/js'))
